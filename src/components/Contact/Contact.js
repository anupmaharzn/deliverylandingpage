        ...
        <section className='contact section container' id='contact'>
            <div className='contact__container grid'>
                ...
                <ul className='contact__content grid'>
                    ...
                    <li className='contact__address'>Email:<span className='contact__information'> delivery@gmail.com</span></li>
                    <li className='contact__address'>Location:<span className='contact__information'> Kathmandu</span></li>
                </ul>
